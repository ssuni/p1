...
*/
	if($p == 1) { 
		echo "<li><img src='../images/board/paging_prev.gif'></li>"; 
	} else { 
		$prevpage = $p-1; 
		echo "<li><a href=$PHP_SELF?$get_val&p=$prevpage><img src='../images/board/paging_prev.gif' border='0'></a></li>";
	}
	...
	if($p == $total_page) {	
		echo "<li><img src='../images/board/paging_next.gif'></li>"; 
	}	else { 
		$nextpage = $p+1; 
		echo"<li><a href=$PHP_SELF?$get_val&p=$nextpage><img src='../images/board/paging_next.gif' border='0'></a></li>"; 
	}
/*
	if($lpage<$total_page) {
		$next10page=$lpage+1;
