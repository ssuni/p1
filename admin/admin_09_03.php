...
<?		// 관리자가 아닐때는 권한 제한
	...
	$whereIs = ( $whereIs ) ? $whereIs." AND tblStrThread='A'" : "WHERE tblStrThread='A'";

	/*월별 회원가입 현황*/
	$Query = "SELECT * FROM tbl_online_counsel ".$whereIs." ORDER BY tblDtmRegDate ASC";
			...
			<table width="99%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<!-- 타이틀 -->
						<table width="99%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="main_title_01">온라인상담 현황</td>
							</tr>
						</table>
						<!-- 검색 테이블 입니다. -->
