...
$naver = new Naver(array(
        ...
        "RETURN_URL" => $nid_mRedirectURL,      // (*필수)콜백 URL
...
/*
로그인 화일 : /www/ammember/login_session.php
// 로그인시 세션은 별도로 설정
echo 'email = '.$user['response']['email'].'<br/>';
echo 'id(사용 아이디) = '.$email_tmp[0].'<br/>';
echo 'id(사용자 확인값) = '.$user['response']['id'].'<br/>';
echo 'nickname = '.$user['response']['nickname'].'<br/>';
*/
?>