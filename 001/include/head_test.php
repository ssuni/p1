...
<link rel='stylesheet' href='../css/floatdiv_skin.css' media='all' /> <!-- 170124 현숙-->
<?if($mn<=0){?>
...
<div id="wrap">
		...
		<div id="header_top">
			<div class="header_top_inner">
				...
				<ul id="util_menu">
					...
					<li><a href="http://www.ppeum2.com/" target="_self" >강남점</a></li>
				...
				<ul class="after">
					...
					<li>
						...
						<ul class="sub">
							...
							<li><a href="../laser/laser05.php">셀리나레이저</a></li>
						</ul>
					</li>
					<li>
	...
	<div id="floatdiv">
		<ul>
			<img src='http://www.ppeum1.com/new/images/main/q_menu_03.png'>
		</ul>	
	</div>