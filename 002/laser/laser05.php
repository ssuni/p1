...
<div id="popup112" class="laserPop" style="position:fixed; z-index:1000; left:50%; top: 200px; margin-left:250px; display:block;">
	<img src="../images/cont/laser/laser05_pop.jpg" class="block">
...
<script>
	...
	<div id="container" class="sub">
		...
		<!-- prod_info -->
		<div id="prod_info">
			<img src="../images/cont/laser/laser05_timg.jpg" class="pimg" alt="">
		...
		<div id="prod_detail">
			<div class="prod_wrap">
				<p class="pos_abs">
					<img src="../images/cont/laser/laser05_cont01.jpg" alt="">
					<img src="../images/cont/laser/laser05_cont02.jpg" alt="">
					<img src="../images/cont/laser/laser05_cont03.jpg" alt="">
				</p>
			</div>
		</div>
		<!-- //prod_detail -->
