<?php
	...
	if( $dNum >= 0 ) {
		@unlink( $_SERVER['DOCUMENT_ROOT'].$Data["savefile"][$dNum] );
		@unlink( $_SERVER['DOCUMENT_ROOT'].$Data["liefile"][$dNum] );
		@unlink( $_SERVER['DOCUMENT_ROOT'].$Data["thumfile1"][$dNum] );
		@unlink( $_SERVER['DOCUMENT_ROOT'].$Data["thumfile2"][$dNum] );
		@unlink( $_SERVER['DOCUMENT_ROOT'].$Data["thumfile3"][$dNum] );
		@unlink( $_SERVER['DOCUMENT_ROOT'].$Data["thumfile4"][$dNum] );
		@unlink( $_SERVER['DOCUMENT_ROOT'].$Data["thumfile5"][$dNum] );
		$Data["savefile"][$dNum] = "";
		$Data["liefile"][$dNum] = "";
		$Data["thumfile1"][$dNum] = "";
		$Data["thumfile2"][$dNum] = "";
