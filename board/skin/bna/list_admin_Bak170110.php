	...
	<table summary="" id="boardList">
		...
		<?		for( $i = 0; $i < $lTmp; $i++ ){
			...
			<tr class="notice">
				...
				<!--<td class="td2">&nbsp;</td>-->
				<td class="td7"><div class="img"><?=$Data[$i]["viewlink"]?><img src="<?if($Data[$i]["thumfile1"][0]!=''){?><?=$Data[$i]["thumfile1"][0]?><?}else{?>/board/skin/<?=$boardSet["skin"];?>/images/noimg.jpg<?}?>" class="noimg" width="150"></a></div></td>
				<td class="td3">
					<div class="cate"><?
