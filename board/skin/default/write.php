...
<?	}	?>
	...
	<?	for( $i = 0; $i < $boardSet["addfilenumber"]; $i++ ){	?>
			<tr>
				...
				<input type="file" name="strSaveFile[]" id="strSaveFile" style="width:70%;height:21px;" class="textForm"><? //권장사이즈 : 252 X 155px ;?></td>
			</tr>
	<?	}	?>
		...
		<?	}	?>
			...
			<tr>
				<td colspan="2">
					...
					<p style="display:none"><textarea name="strComment" id="strComment" style="width:100%; height:150px"></textarea></p>	
				</td>
			</tr>
		</tbody>
	</table>
