...
<link rel='stylesheet' href='../css/fixedstyle.css' media='all' /><!-- // gnb 상단고정 170118 현숙 -->
...
<script src='../js/common.js'></script><!-- 링크및기타 -->
<?if($mn<=0){?>
...
<? } ?>
<script src='../js/gnb_fixed.js'></script><!-- // gnb 상단고정 170118 현숙 -->
			...
			<ul class="gnb_list">
				...
				<li>
					...
					<ul class="sub">
						...
						<li><a href="http://plus.kakao.com/home/@쁨클리닉신논현점">카카오톡상담</a></li>
