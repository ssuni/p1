	...
	<div id="container" class="board">
		...
		<p class="top_txt">빠르고 정확하게 상담해드리겠습니다.</p>
			...
			<div class="form_area2">
				<form name="kakao" method="post" action="/m/board/kakao_proc.php" onSubmit="return kakaoSubmit()">
				<h3>개인정보 수집·이용 동의 안내<br><span class="st">※ 동의를 거부할 수 있습니다. 동의 거부시에는 상담서비스 이용이 제한됩니다.</span></h3>
				<div class="agree_box">
					<table summary="">
						<caption></caption>
						<colgroup>	
				...
				<table summary="" class="form_list">
					...
					<tbody>
						...
						<tr>
							<th>카톡아이디</th>
							<td><input name="tblStrKatok" type="text" style="width:250px;" class="form1" id="tblStrKatok" value="<?=$_SESSION["ss_id"];?>"> <span class="stext">(예) ppeum01</span></td>
						</tr>
						<tr>
							<th>나이</th>
							<td>
