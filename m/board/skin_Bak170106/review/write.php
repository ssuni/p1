...
<? if(!$_SESSION["ss_id"]){ ?>
	...
	<div class="agreeBox">
		...
		<p><input name="agree" type="checkbox">&nbsp;개인정보취급방침에 동의합니다</p>
	</div>
	<!----//개인정보를 받는 모든 게시판에 개인정보취급방침 동의---->
	<? } ?>
	...
	<?	if( $_SESSION["ss_level"] <= 2 ){	?>
		...
		<?	}	?>
			...
			<tr>
				<th>이미지첨부</th>
				<td><a href="javascript:popupImgAdd();"><img src="/editor/img/ko_KR/btn_add_image.gif"></a></td>
			</tr>
			<tr>
				<td colspan="2">
