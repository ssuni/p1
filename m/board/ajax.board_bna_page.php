<?php
	...
	while($Array = mysql_fetch_array( $Sql )) {
		...
		$bnf_wrap_li .= '<li '.$margin_0.'><img src="'.$bagData["host"].$Data["savefile"][0].'" width="180" height="117" alt="'.$Array["tblStrSubject"].'" number="'.$Array["tblNumber"].'" style="opacity: 0.5;"/><p>'.mb_strimwidth( stripslashes( $Array["tblStrSubject"]), 0, ceil(20), "..", "utf-8" ).'</p></li>';
	}
